...
public class Namespaces {
	...
	public static final String WSSEC1 = "http://docs.oasis-open.org/wss/oasis-wss-wssecurity-secext-1.1.xsd";
//	public static final String SOAPSEC = "http://schemas.xmlsoap.org/soap/security/2000-12";
	...
	public static Map<String, String> getExistingNamespaces(Element element) {
		...
		return Collections.unmodifiableMap(knownNamespaces); // key:namespace,
																// value:prefix
	}
